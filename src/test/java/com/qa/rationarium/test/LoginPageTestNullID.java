...
/*
#1 TC if users does not enter UserID

 */

public class LoginPageTestNullID extends BaseClass {
    ...
    public void logintest(String scenario, String email, String pwd) {
        ...
        if (scenario.equalsIgnoreCase("UID")) {
            ...
            String errorMsgUID = lp.getErrorValidationText(lp.getEmptyUserError());
            System.out.println(errorMsgUID);
            Assert.assertEquals(errorMsgUID.trim(), emptyUserError);
            // page.close();
